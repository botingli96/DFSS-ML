...
name_format = "FCNN_Bz_run21"
print("Note: use results33.mat as train data, results36.m as test data; B only has positive Z values; Outliar")
# File paths for training and testing data
train_file_path = os.path.join('MATLAB_DATA', 'results33.mat')  # For training
test_file_path = os.path.join('MATLAB_DATA', 'results36.mat')   # For testing
