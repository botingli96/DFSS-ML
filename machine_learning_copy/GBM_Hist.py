...
name_format = "GBM_Hist_run27"
print("Note: use results40.mat which has 3000 datasets; B only has positive Z values; 100, 0.12, 14")
file_path = os.path.join('MATLAB_DATA', 'results40.mat')  # Replace with your actual file path
