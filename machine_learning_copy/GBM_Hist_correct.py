...
name_format = "GBM_Hist_run23_new"
print("Note: use results38.mat which has 1000 datasets; B only has positive Z values; 100, 0.12, 14")
file_path = os.path.join('MATLAB_DATA', 'results38.mat')  # Replace with your actual file path
...
model_save_path = os.path.join("/home/botingl/machine learning copy/results", generate_filename("trained_multioutput_gbm_model", "joblib"))

# Save the trained model using joblib
joblib.dump(multi_gbm, model_save_path)
print("Model saved successfully.")

# Define the path where the model was saved
model_load_path = os.path.join("/home/botingl/machine learning copy/results", generate_filename("trained_multioutput_gbm_model", "joblib"))
