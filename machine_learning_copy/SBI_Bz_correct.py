...
name_format = "SBI_Bz_run22_new"
print("Note: use results39.mat which has 2000 datasets; B only has positive Z values, learning rate 0.0001, batch size 32.")
file_path = os.path.join('MATLAB_DATA', 'results39.mat')  # Replace with your actual file path
...
# Save the model
posterior_path = os.path.join("/home/botingl/machine learning copy/results", generate_filename("posterior", "pt"))
density_estimator_path = os.path.join("/home/botingl/machine learning copy/results", generate_filename("density_estimator", "pt"))
