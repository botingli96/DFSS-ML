...
name_format = "FCNN_Bz_noprep_run13"
print("Note: use results24.mat which has 1000 datasets; B only has positive Z values")
file_path = os.path.join('MATLAB_DATA', 'results24.mat')  # Replace with your actual file path
