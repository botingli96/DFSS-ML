...
name_format = "GBM_XGB_run24"
print("Note: use results16.mat as train data, results18.m as test data; B only has positive Z values; Outliar; 350, 0.08, 6")
...
test_file_path = os.path.join('MATLAB_DATA', 'results18.mat')   # For testing
